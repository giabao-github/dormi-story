  ...
  if (paragraph) {
    ...
    return (
      <div className='relative flex items-center w-full mx-4'>
        ...
        <input
          className={twMerge(`flex flex-row justify-between items-center w-full rounded-full px-5 py-3 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 bg-neutral-100 border border-neutral-400 focus:border-none focus:ring focus:ring-rose-300`, className)}
          disabled={disabled}
          type={type}
          value={value}
          ...
          onChange={(e) => {
            ...
            searchResult.setValue(e.target.value);
          }}
